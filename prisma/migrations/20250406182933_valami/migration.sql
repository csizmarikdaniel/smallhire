...
INSERT INTO "new_Image" ("createdAt", "id", "profileImage", "referenceId", "reservationId", "updatedAt", "url", "userId") SELECT "createdAt", "id", "profileImage", "referenceId", "reservationId", "updatedAt", "url", "userId" FROM "Image";
DROP TABLE "Image";
